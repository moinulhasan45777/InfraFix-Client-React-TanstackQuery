...
const CitizenProfile = () => {
  ...
  const handleSubscribe = () => {
    Swal.fire({
      title: "Are you sure?",
      text: "You will be charged BDT 1000 for Subscription!",
      icon: "warning",
    ...
    <div className="max-w-md mx-auto bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="flex flex-col items-center mb-6">
        <div className="relative">
          ...
          {citizen[0]?.status == "Paid" && (
            <span className="absolute -bottom-1 -right-1 bg-linear-to-br from-yellow-400 to-yellow-600 text-white p-2 rounded-full shadow-md">
              <Crown size={18} />
            </span>
          )}
        </div>
        ...
        {citizen[0]?.status != "Paid" && (
          <button
            ...
            type="button"
            className="mt-4 px-5 py-2 text-sm font-medium rounded-md bg-yellow-500 text-white hover:bg-yellow-600 transition"
          >

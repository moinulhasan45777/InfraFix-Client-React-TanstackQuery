  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="rounded-2xl shadow-lg p-8 bg-blue-100 flex flex-col justify-between hover:shadow-xl transition-shadow">
          <p className="text-base font-medium text-gray-700 mb-2">
            Total Issues
          </p>
          <p className="text-4xl font-bold text-blue-700">{issues.length}</p>
        </div>

        {/* Pending Issues */}
        <div className="rounded-2xl shadow-lg p-8 bg-yellow-100 flex flex-col justify-between hover:shadow-xl transition-shadow">
          <p className="text-base font-medium text-gray-700 mb-2">
            Pending Issues
          </p>
        ...
        {/* In-Progress Issues */}
        <div className="rounded-2xl shadow-lg p-8 bg-orange-100 flex flex-col justify-between hover:shadow-xl transition-shadow">
          <p className="text-base font-medium text-gray-700 mb-2">
            In-Progress Issues
          </p>
        ...
        {/* Resolved Issues */}
        <div className="rounded-2xl shadow-lg p-8 bg-green-100 flex flex-col justify-between hover:shadow-xl transition-shadow">
          <p className="text-base font-medium text-gray-700 mb-2">
            Resolved Issues
          </p>
        ...
        {/* Rejected Issues */}
        <div className="rounded-2xl shadow-lg p-8 bg-red-100 flex flex-col justify-between hover:shadow-xl transition-shadow">
          <p className="text-base font-medium text-gray-700 mb-2">
            Rejected Issues
          </p>
        ...
        {/* Total Payments */}
        <div className="rounded-2xl shadow-lg p-8 bg-purple-100 flex flex-col justify-between hover:shadow-xl transition-shadow">
          <p className="text-base font-medium text-gray-700 mb-2">
            Total Payment
          </p>
